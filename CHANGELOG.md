...
* PR #888: Added logs in getAllSolutionsByUser handler in UserController.
* PR #887: Replaced Hardcoded return all of a user’s challenge solution from PR #884 with the actual return.
