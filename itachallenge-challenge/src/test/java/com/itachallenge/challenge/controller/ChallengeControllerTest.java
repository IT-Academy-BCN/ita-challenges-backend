...
class ChallengeControllerTest {
    ...
    @Test
   	...
   	void testRelatedChallenge_VALID_SET() {
       		...
       		/*Mono<ResponseEntity<Set<RelatedDto>>> responseRelated = challengeController.relatedChallenge(VALID_ID);
            StepVerifier.create(responseRelated)
                    .expectNextMatches(responseInternal -> responseInternal.getStatusCode().equals(OK))
                    .verifyComplete();*/
