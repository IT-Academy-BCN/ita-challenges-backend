...
class ChallengeRepositoryTest {
    ...
    void findAllByResourcesContaining_ShouldReturnMatchingChallenges() {
        ...
        String resourceId = "3b6ac964-dc93-4c14-a4da-e20a977c4c4a";

        // Init Data
        Challenge challenge1 = Challenge.builder()
                .uuid("c99f27b9-1dfb-483a-aa2b-33021000b0c1")
                .resources(Set.of("09dd7278-8be5-471a-b706-abda9150094f","3b6ac964-dc93-4c14-a4da-e20a977c4c4a"))
                .build();

        Challenge challenge2 = Challenge.builder()
                .uuid("330a49d1-84cb-4e89-adf3-5e439aeb3c41")
                .resources(Set.of("3a9a92b9-4e0e-4fda-b4c6-b6d3de0e8e3c","0a67c417-03ab-4ad2-8989-7c764bdf2230"))
                .build();
