...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MessageDto> handleForbiddenException(ForbiddenException ex) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(new MessageDto(ex.getMessage()));
    }
