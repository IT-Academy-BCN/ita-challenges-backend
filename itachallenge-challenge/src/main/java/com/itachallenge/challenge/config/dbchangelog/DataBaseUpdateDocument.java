...
@ChangeUnit(id = "Update Documents", order = "4", author = "Dani Diaz")
public class DataBaseUpdateDocument {
    ...
    private static final String NEW_FIELD_NAME = "LanguageUpdated";
    ...
    private void addFieldToAllDocuments(ReactiveMongoTemplate mongoTemplate) {
        ...
        }).doOnError(error -> logger.error("Error during update: {}", error.getMessage())).subscribe();
    }
