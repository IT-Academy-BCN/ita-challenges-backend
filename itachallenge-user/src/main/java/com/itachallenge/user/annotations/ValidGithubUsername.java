...
@Documented
@Constraint(validatedBy = GithubUsernameValidator.class) // Specifies the validator class
@Target({ ElementType.FIELD, ElementType.PARAMETER }) // Applicable to method parameters and fields
