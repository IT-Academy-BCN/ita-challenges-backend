...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public Mono<UserDocument> getUserByGithubUsername(String githubUsername) {
        return userRepository.findByUsername(githubUsername)
                .switchIfEmpty(Mono.error(new NotFoundException("User not found with GitHub username: " + githubUsername)));
    }
}
