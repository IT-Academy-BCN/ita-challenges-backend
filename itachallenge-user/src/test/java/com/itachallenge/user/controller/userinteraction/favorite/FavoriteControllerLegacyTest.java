...
class FavoriteControllerLegacyTest {
    ...
    static class TestConfig {
        ...
        @Bean(name="legacyWebClientBuilder")
    ...
    void getUserFavorites_returnsFavorites_Legacy() {
    ...
    void getUserFavorites_returns404IfUserNotFound_Legacy() {
        UUID userId = UUID.randomUUID();
    ...
    void getUserFavorites_returns400IfInvalidUUID_Legacy() {
    ...
    @Test
    void deleteFromFavorites_WhenUserNotExists_Returns404_Legacy() {
        String userId = UUID.randomUUID().toString();
        String challengeId = UUID.randomUUID().toString();
        when(favoriteService.deleteChallengeFromFavorites(userId, challengeId))
                .thenReturn(Mono.error(new NotFoundException("User not found")));
