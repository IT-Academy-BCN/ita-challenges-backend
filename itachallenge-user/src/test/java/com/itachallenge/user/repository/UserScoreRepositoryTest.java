...
class UserScoreRepositoryTest {
    ...
    public void setUp() {
        ...
        UserSolutionDocument userScoreDocument1 = new UserSolutionDocument(uuid_1, userId1, challengeId1, languageId1, true, ChallengeStatus.STARTED, 90, solutionDocumentList, errors);
        UserSolutionDocument userScoreDocument2 = new UserSolutionDocument(uuid_2, userId2, challengeId2, languageId2, true, ChallengeStatus.STARTED, 90, solutionDocumentList, errors);
        UserSolutionDocument userScoreDocument3 = new UserSolutionDocument(uuid_3, userId1, challengeId1, languageId1, true, ChallengeStatus.STARTED, 90, solutionDocumentList, errors);
