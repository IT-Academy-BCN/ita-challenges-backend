...
class UserScoreServiceImpTest {
    ...
    void getUserScoreByUserId() {
       ...
       UserSolutionDocument userSolutionDocument = new UserSolutionDocument(UUID.randomUUID(), userId, idChallenge, idLanguage, true, ChallengeStatus.STARTED, 1, "x", solutionDocumentList);
